...
typedef struct ESMPPDecContext {
    ...
    int buf_cache_mode;
    int dfd;
    int disable_ec; // disable hardware error concealment
    int drop_err_frame;
    // crop
    char *crop;
    int crop_xoffset;
...
#define ESMPP_VDEC_COMMON_OPTIONS                                                                                      \
    {"die_idx",                                                                                                        \
     ...
     "die_idx"},                                                                                                       \
        ...
        {"disable_ec", "disable hw error concealment", OFFSET(disable_ec), AV_OPT_TYPE_INT, {.i64 = 0}, 0, 1, VD},     \
        {"drop_err_frame", "drop error frames", OFFSET(drop_err_frame), AV_OPT_TYPE_INT, {.i64 = 0}, 0, 1, VD},        \
        {"dec_pixfmt",                                                                                                 \
