...
static const AVOption options[] = {
    ...
    {"crop", "crop (xoffset)x(yoffset)x(width)x(height)", OFFSET(crop), AV_OPT_TYPE_STRING, {.str = NULL}, 0, 0, VD},
...
static const enum AVPixelFormat mpp_dec_pix_fmts[] = {
