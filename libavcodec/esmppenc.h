...
#define ASYNC_FRAMES 3  // current max gop size 4 - 1
#define ALIGN_DOWN(a, b) ((a) & ~((b) - 1))
#define H26X_MAX_QP 32
#define TRUE 1
#define FALSE 0

#define MAX_HEIGHT_VIDEO 8192
#define MAX_WIDTH_VIDEO 8192
...
typedef struct ESMPPEncContext {
    ...
    int insert_vui;
    int insert_video_signal_type_at_vui;
    int insert_sar_at_vui;
...
#define ESMPP_ENC_COMMON_OPTS                                                                                         \
    {"async_frames",                                                                                                  \
     "set the async_frames of input queue. range[0,8]",                                                               \
     OFFSET(async_frames),                                                                                            \
     AV_OPT_TYPE_INT,                                                                                                 \
     {.i64 = -1},                                                                                                      \
     -1,                                                                                                               \
     ...
     VE},                                                                                                             \
    {"die_idx",                                                                                                       \
     "set the idx of die for multiple dies version. range[0,1]",                                                      \
     OFFSET(die_idx),                                                                                                 \
     AV_OPT_TYPE_INT,                                                                                                 \
     {.i64 = 0},                                                                                                      \
     0,                                                                                                               \
     ...
     VE},                                                                                                             \
        ...
        {"stat_time",                                                                                                 \
         "Bit rate statistical time in second[1, 60]",                                                                \
         OFFSET(stat_time),                                                                                           \
         AV_OPT_TYPE_INT,                                                                                             \
         {.i64 = 1},                                                                                                  \
         1,                                                                                                           \
         ...
         "stat_time"},                                                                                                \
        {"start_qp",                                                                                                  \
         "Start QP value of the frame that is being encoded.[0, 51]",                                                 \
         OFFSET(start_qp),                                                                                            \
         AV_OPT_TYPE_INT,                                                                                             \
         {.i64 = -1},                                                                                                 \
         -1,                                                                                                          \
        ...
        {"frame_dump_time",                                                                                           \
         ...
         VE},                                                                                                         \
        {"packet_dump_time",                                                                                          \
         "the time length of dumpping packet",                                                                        \
         OFFSET(dump_pkt_time),                                                                                       \
         AV_OPT_TYPE_INT,                                                                                             \
         {.i64 = 0},                                                                                                  \
         0,                                                                                                           \
         INT_MAX,                                                                                                     \
         VE},                                                                                                         \
        {"max_width", "set the max width", OFFSET(max_width), AV_OPT_TYPE_INT, {.i64 = 0}, 0, MAX_WIDTH_VIDEO, VE}, { \
        "max_height", "set the max height", OFFSET(max_height), AV_OPT_TYPE_INT, {.i64 = 0}, 0, MAX_HEIGHT_VIDEO, VE  \
    }
    ...
    {"bitdepth",                                                                                                   \
     ...
     "bitdepth"},                                                                                                  \
        ...
        {"mastering_display",                                                                                      \
         ...
         VE},                                                                                                      \
        {"content_light",                                                                                          \
         "content_light 'maxcll:N,maxfall:N'",                                                                     \
         OFFSET(content_light),                                                                                    \
         AV_OPT_TYPE_STRING,                                                                                       \
         {.str = NULL},                                                                                            \
         0,                                                                                                        \
         0,                                                                                                        \
         VE},                                                                                                      \
        {"insert_vui", "enable/disable insert vui", OFFSET(insert_vui), AV_OPT_TYPE_INT, {.i64 = 1}, 0, 1, VE},    \
        {"insert_video_signal_type_at_vui",                                                                        \
         "insert video signal type at vui",                                                                        \
         OFFSET(insert_video_signal_type_at_vui),                                                                  \
         AV_OPT_TYPE_INT,                                                                                          \
         {.i64 = 1},                                                                                               \
         0,                                                                                                        \
         1,                                                                                                        \
         VE},                                                                                                      \
    {                                                                                                              \
        "insert_sar_at_vui", "insert sar at vui", OFFSET(insert_sar_at_vui), AV_OPT_TYPE_INT, {.i64 = 1}, 0, 1, VE \
    }
...
#define ESMPP_ENC_VIDEO_RC_OPTS                                                                                      \
    {"cpb_size", "[10, 800000]", OFFSET(cpb_size), AV_OPT_TYPE_INT, {.i64 = -1}, -1, 800000, VE, "cpb_size"},        \
        {"iqp", "Set qp of I-frame", OFFSET(iqp), AV_OPT_TYPE_INT, {.i64 = 30}, 0, 51, VE, "iqp"},                   \
        {"pqp", "Set qp of P-frame", OFFSET(pqp), AV_OPT_TYPE_INT, {.i64 = 32}, 0, 51, VE, "pqp"},                   \
        {"bqp", "Set qp of B-frame", OFFSET(bqp), AV_OPT_TYPE_INT, {.i64 = 32}, 0, 51, VE, "bqp"},                   \
        {"iprop",                                                                                                    \
...
static const AVOption hevc_options[] = {
    ...
    {"preset",
     ...
     OFFSET(preset),
     AV_OPT_TYPE_INT,
     {.i64 = MPP_ENC_PRESET_DEFAULT},
     MPP_ENC_PRESET_DEFAULT,
     MPP_ENC_PRESET_SLOW,
     VE,
     "preset"},
    {"default", NULL, 0, AV_OPT_TYPE_CONST, {.i64 = MPP_ENC_PRESET_DEFAULT}, INT_MIN, INT_MAX, VE, "preset"},
    {"fast", NULL, 0, AV_OPT_TYPE_CONST, {.i64 = MPP_ENC_PRESET_FAST}, INT_MIN, INT_MAX, VE, "preset"},
    {"medium", NULL, 0, AV_OPT_TYPE_CONST, {.i64 = MPP_ENC_PRESET_MEDIUM}, INT_MIN, INT_MAX, VE, "preset"},
    {"slow", NULL, 0, AV_OPT_TYPE_CONST, {.i64 = MPP_ENC_PRESET_SLOW}, INT_MIN, INT_MAX, VE, "preset"},
    {"profile",
     "Set the encoding profile",
     OFFSET(profile),
     AV_OPT_TYPE_INT,
...
static const FFCodecDefault esmpp_enc_defaults[] = {{"b", "2M"}, {"g", "75"}, {"bf", "2"}, {NULL}};
