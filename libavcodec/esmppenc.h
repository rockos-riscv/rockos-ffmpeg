    ...
    {"stride_align",                                                                                                  \
     ...
     VE},                                                                                                             \
        ...
        {"rc_mode",                                                                                                   \
         ...
         VE,                                                                                                          \
         "rc_mode"},                                                                                                  \
        {"VBR", NULL, 0, AV_OPT_TYPE_CONST, {.i64 = 0}, 0, 0, VE, "rc_mode"},                                         \
        {"CBR", NULL, 0, AV_OPT_TYPE_CONST, {.i64 = 1}, 0, 0, VE, "rc_mode"},                                         \
...
#define ESMPP_ENC_VIDEO_COMMON_OPTS                                                                                   \
    {"bitdepth",                                                                                                      \
     ...
     "bitdepth"},                                                                                                     \
    {                                                                                                                 \
        "enable_deblock", "Enable deblock filter", OFFSET(enable_deblocking), AV_OPT_TYPE_INT, {.i64 = -1}, -1, 1, VE \
    }
